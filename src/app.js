...
const INITIAL_PLAYERS = [
    {
        ...
        stats: {
            pac: 88, sho: 93, pas: 80, dri: 85, def: 35, phy: 78
        }
    },
    {
        id: "2",
        ...
        stats: {
            pac: 72, sho: 86, pas: 94, dri: 87, def: 65, phy: 78
        }
    },
    {
        id: "3",
        ...
        stats: {
            pac: 78, sho: 60, pas: 71, dri: 72, def: 89, phy: 86
        }
    },
    {
        id: "4",
        ...
        stats: {
            pac: 86, sho: 85, pas: 85, dri: 89, def: 54, phy: 90 // (DIV, HAN, KIC, REF, SPD, POS for GK)
        }
    },
    {
        id: "5",
        ...
        stats: {
            pac: 86, sho: 83, pas: 85, dri: 92, def: 37, phy: 61
        }
    },
    {
        id: "6",
        ...
        stats: {
            pac: 72, sho: 76, pas: 89, dri: 86, def: 72, phy: 66
        }
    }
];
...
function setAdminState(active) {
    ...
    if (active) {
        ...
        authBtn.innerHTML = '<i class="fa-solid fa-right-from-bracket"></i> <span>Logout Manager</span>';
        authBtn.classList.remove("btn-primary");
        authBtn.classList.add("btn-secondary");
        adminStatusBar.innerHTML = '<span class="status-badge admin-badge"><i class="fa-solid fa-user-gear"></i> Manager Mode</span>';
        addPlayerBtn.style.display = "inline-flex";
    } else {
        sessionStorage.removeItem("apex_admin_auth");
        authBtn.innerHTML = '<i class="fa-solid fa-lock"></i> <span>Manager Login</span>';
        authBtn.classList.remove("btn-secondary");
        authBtn.classList.add("btn-primary");
        adminStatusBar.innerHTML = '<span class="status-badge public-badge"><i class="fa-solid fa-eye"></i> Public View</span>';
...
function renderPlayers() {
    ...
    const filtered = players.filter(player => {
        const matchesSearch = player.name.toLowerCase().includes(searchVal) || 
    ...
    playersGrid.innerHTML = filtered.map(player => {
        ...
        let label1 = "PAC", label2 = "SHO", label3 = "PAS";
        let label4 = "DRI", label5 = "DEF", label6 = "PHY";
        
        if (player.position === "Goalkeeper") {
            label1 = "DIV"; label2 = "HAN"; label3 = "KIC";
            label4 = "REF"; label5 = "SPD"; label6 = "POS";
        }
